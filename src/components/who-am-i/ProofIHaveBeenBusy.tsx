  ...
  return (
    <section className='flex flex-col items-center justify-center py-12 min-h-screen'>
        <div className='flex flex-col items-center justify-center w-full max-w-3xl px-2 text-center'>
            <div className="rail justify-center"><span className="idx">02</span><h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold tracking-heading leading-tight text-ink">Proof I&apos;ve Been Learning</h1><RevealTick /></div>
