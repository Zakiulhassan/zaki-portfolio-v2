  ...
  return (
    <section className='flex flex-col items-center justify-center py-12'>
        <div className='flex flex-col items-center justify-center w-full max-w-3xl px-2'>
            ...
            <p className='text-lg font-normal text-center leading-tight text-white mt-1'>Behind every great designer is a stack of certifications. Okay, maybe not a stack, but these are the ones that have helped me level up. Here&apos;s what I&apos;ve achieved so far.</p>
        </div>
