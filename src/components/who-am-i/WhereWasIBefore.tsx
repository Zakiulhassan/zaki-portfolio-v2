  ...
  return (
    <section className='flex flex-col items-center justify-center'>
        <div className='flex flex-col items-center justify-center w-full max-w-3xl px-2'>
            ...
            <p className='text-lg font-normal text-center font-jakarta leading-tight text-primary'>Here&apos;s a brief look at my career journey—filled with design milestones and problem-solving adventures. I&apos;ve been preparing for this moment!</p>
        </div>
