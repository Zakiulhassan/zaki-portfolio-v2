...
export function LogoMarquee() {
  return (
    <div className="relative flex max-w-[540px] w-full flex-col items-center justify-center overflow-hidden bg-transparent">
      ...
      <div className="pointer-events-none absolute inset-y-0 left-0 w-1/3 bg-gradient-to-r from-[#f9f8f0] dark:from-gray-800"></div>
      <div className="pointer-events-none absolute inset-y-0 right-0 w-1/3 bg-gradient-to-l from-[#fcfbf4] dark:from-gray-800"></div>
    </div>
  );
}
